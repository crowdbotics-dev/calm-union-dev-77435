"""
Django settings for calm_union_dev_77435 project.
...
ROOT_URLCONF = 'calm_union_dev_77435.urls'
...
WSGI_APPLICATION = 'calm_union_dev_77435.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_union_dev_77435 API",
    "DESCRIPTION": "API documentation for calm_union_dev_77435 App",
    "VERSION": "v1",
}
